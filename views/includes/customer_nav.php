              ...
              <div class="hidden sm:ml-6 sm:flex gap-2 sm:items-center">
                ...
                <div class="relative ml-3" x-data="{ open: false }">
                  ...
                  <div x-show="open" @click.away="open = false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1" style="display: none;">
                    <a href="<?=App_Url?>logout" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</a>
                  </div>
                </div>
              </div>
          ...
          <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu" style="display: none;">
            ...
            <div class="border-t border-emerald-700 pb-3 pt-4">
              ...
              <div class="mt-3 space-y-1 px-2">
                <a href="<?=App_Url?>logout" class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-emerald-500 hover:bg-opacity-75">Sign out</a>
              </div>
            </div>
          </div>
        </nav>
